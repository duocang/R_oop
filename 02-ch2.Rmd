...
<img src="https://raw.githubusercontent.com/duocang/images/master/PicGo/20210409224651.png"/>
...
<img src="https://raw.githubusercontent.com/duocang/images/master/PicGo/20210409224826.png"/>
...
<img src="https://raw.githubusercontent.com/duocang/images/master/PicGo/20210409225116.png"/>
...
student.exam <- function(x, subject="语文") print(paste0(subject, "考试"))
...
attr(b, "class") <- "exam"
student(b, subject="体育")

attr(a,'class') <- 'assignment'
teacher(a)
```

上面的student和teacher在概念上市class，但实质又是generic function.

这种设计以lecture ,assignment ,exam 对象也可以。
```{r}
